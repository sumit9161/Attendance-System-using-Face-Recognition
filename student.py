...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\HP\Downloads\college-images\college_images\face-recognition.png")
        ...
        #2nd image
        img1=Image.open(r"C:\Users\HP\Downloads\college-images\college_images\smart-attendance.jpg")
        ...
        #3rd image
        img2=Image.open(r"C:\Users\HP\Downloads\college-images\college_images\iStock-182059956_18390_t12.jpg")
        ...
        img_right=Image.open(r"C:\Users\HP\Downloads\college-images\college_images\student.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_Std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                my_cursor.execute("insert into studetnt values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.var_dep.get(),
                                                                                                            self.var_course.get(),
                                                                                                            self.var_year.get(),
...
#========= updata function=========
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                Update=messagebox.askyesno("Updata","Do you want to updata this student details",parent=self.root)
                if Update>=0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Test@123",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(self.var_dep.get(),
                                                                                                self.var_course.get(),
                                                                                                self.var_year.get(),
                                                                                                self.var_semester.get(),
